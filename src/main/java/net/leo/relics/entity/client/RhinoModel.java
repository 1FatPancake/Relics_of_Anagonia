package net.leo.relics.entity.client;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.leo.relics.entity.animations.RelicAnimationDefinitions;
import net.leo.relics.entity.custom.RhinoEntity;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(RhinoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(RelicAnimationDefinitions.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(entity.idleAnimationState, RelicAnimationDefinitions.RHINO_IDLE, ageInTicks, 1f);
	}
